  ...
  <div class="col-6">
    <div class="card shadow border-left-primary">
      <div class="card-body">
        ...
        <form action="/laporan/{{$p->id}}/update" method="POST" class="d-inline">
          @CSRF
          @method('PUT')
        ...
        <x-button link="/laporan" text="Kembali" type="secondary"/>
        <a href="/laporan/siswa/print" class="btn btn-primary ">Cetak<i class="fas fa-print"></i></a>
